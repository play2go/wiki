...
Сам конфигурационный файл Floodgate находится в папке `plugins/Floodgate` под названием `config.yml`. Если это необходимо, можно настроить некоторые параметры по своему усмотрению.
