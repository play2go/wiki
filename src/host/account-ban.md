...
Если вы всё же считаете, что блокировку выдали неверно - напишите в поддержку на [Discord сервере](https://discord.gg/play2go), в канал с тикетами в категорию "Проблема с аккаунтом". 
На данный момент создание новых тикетов в Discord временно приостановлено, используйте [Telegram](https://t.me/play2go_support).
