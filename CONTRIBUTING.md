...
9. При вставке изображений в статью нужно использовать компонент `AImg`, а не стандартную конструкцию `![]()`: первый, в отличие от второго, позволяет увеличивать изображения по клику мыши. Пример его использования: `<AImg src="путь к изображению" alt="альтернативный текст (указывать не обязательно)"/>`.
